            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                <form method="POST" action="signup.php">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="password" id="confirmPassword" name="confirmPassword" required class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
